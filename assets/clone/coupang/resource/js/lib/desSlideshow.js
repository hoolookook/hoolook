...
(function (a) {
  a.fn.desSlideshow = function (p) {
    ...
    function init() {
      g.css("width", slideshow_width + "px")
        .css("height", slideshow_height + "px")
      ...
      g.find("li")
        .css("margin", "0px")
        .css("padding", "0.5px 0px 0.5px 0px")
        .css("list-style", "none");
      ...
      g.find(".nav")
        .children("li")
        .css("height", "60px")
        // .css("background-image", "url(" + directory + "flashtext-bg.jpg)")
    ...
    function showpic() {
      ...
      g.find(".nav")
        .children("li")
        .eq(current)
        // .css("background-image", "url(" + directory + "flash-on.gif)")
        .css("border-bottom", "none");
      g.find(".switchBigPic").children("div").fadeOut();
      g.find(".switchBigPic").children("div").eq(current).fadeIn();
      g.find(".nav").children("li").eq(current);
      // .animate({ marginLeft: "-35px" }, "fast");
      g.find(".nav")
        .children("li")
        .eq(w)
