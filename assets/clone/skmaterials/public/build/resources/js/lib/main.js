...
$(document).ready(function () {
  ...
  function hoverFun(hovering) {
    if (hovering) {
      ...
      $(".logo img").attr(
        "src",
        "/assets/images/icons/header-ci-black.png"
      );
      $(".navWrap .nav .login").css({
        "background-image":
          "url(/assets/images/icons/nav-login-icon-black.png)",
      });
      $(".navWrap .nav a").css({
        color: "black",
      });
      ...
      $(".logo img").attr(
        "src",
        "/assets/images/icons/header-ci-white.png"
      );
      $(".navWrap .nav .login").css({
        "background-image":
          "url(/assets/images/icons/nav-login-icon-white.png)",
      });
      $(".navWrap .nav a").css({
        color: "white",
      });
