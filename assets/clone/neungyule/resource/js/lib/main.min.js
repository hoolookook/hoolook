...
$(".dropbtn").click(function () {
  if ($(".dropdown-content").css("display") == "none") {
    ...
    $(".familySite img").attr(
      "src",
      "../../resource/images/neungyule/bg_family_close.png"
    );
  } else {
    $(".dropdown-content").css("display", "none");
    $(".familySite img").attr(
      "src",
      "../../resource/images/neungyule/bg_family.png"
    );
  }
});
$(".slideBtn").click(function () {
  if ($(".hideBar").css("display") == "none") {
    $(".neInfo").css({
      "background-image":
        "url(../../resource/images/neungyule/bg_ticker3.png)",
    });
    $(".hideBar").slideDown("fast");
  } else {
    $(".neInfo").css({
      "background-image":
        "url(../../resource/images/neungyule/bg_ticker3_on.png)",
    });
